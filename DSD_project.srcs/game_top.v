`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// Module:      game_top.v (v4 - cleanly ordered, smooth camera, airborne fix)
// Description:
//   Top-level for Crossy Road. Includes log-riding, camera smoothing,
//   and correct declaration ordering to pass Vivado synthesis.
//////////////////////////////////////////////////////////////////////////////////
...
module game_top (
    ...
    // ALL 11-bit coordinates declared HERE before use to prevent 
    // implicit 1-bit wire width mismatch warnings.
    ...
    //Collision - chicken's current lane
    ...
    // AIRBORNE FIX: Protect the chicken from false river deaths mid-jump
    wire is_jumping = (chicken_y != render_chicken_y);
    wire any_collision = (car_hit_1 | car_hit_2 | river_death | carried_offscreen) && !is_jumping;
